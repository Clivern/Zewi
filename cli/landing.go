...
var landingCmd = &cobra.Command{
	Use:   "landing",
	Short: "Start the zewi landing page server",
	Run: func(_ *cobra.Command, _ []string) {
		...
		r := core.SetupLanding(Static)

		// Run the server
		if err := core.RunLanding(r); err != nil {
...
func init() {
	...
	landingCmd.MarkFlagRequired("config")
